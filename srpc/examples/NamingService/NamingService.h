...
public:
     ...
     * - 응답: onBind
     */
    DECLARE_SRPC_METHOD_2(NamingService, bind,
    ...
    * - 응답: onRebind
    */
    DECLARE_SRPC_METHOD_2(NamingService, rebind,
        srpc::RString, name, srpc::RString, value);
    ...
    * - 응답: onUnbind
    */
    DECLARE_SRPC_METHOD_1(NamingService, unbind, srpc::RString, name);

    /**
    * 데이터베이스 조회를 합니다.
    * - 응답: onResolve
    */
    DECLARE_SRPC_METHOD_1(NamingService, resolve, srpc::RString, name);
     ...
     */
    DECLARE_SRPC_METHOD_3(NamingService, onBind,
     ...
     * @param succeeded 성공할 경우 true, 실패할 경우 false.
     */
    DECLARE_SRPC_METHOD_3(NamingService, onRebind,
        srpc::RString, name, srpc::RString, value, srpc::RBool, succeeded);
     ...
     * @param succeeded 성공할 경우 true, 실패할 경우 false.
     */
    DECLARE_SRPC_METHOD_2(NamingService, onUnbind,
    ...
    * @param succeeded 성공할 경우 true, 실패할 경우 false.
    */
    DECLARE_SRPC_METHOD_3(NamingService, onResolve,
        srpc::RString, name, srpc::RString, value, srpc::RBool, succeeded);
};
