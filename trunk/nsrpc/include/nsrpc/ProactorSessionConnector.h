#ifndef NSRPC_PROACTORSESSIONCONNECTOR_H
#define NSRPC_PROACTORSESSIONCONNECTOR_H
...
public:
     ...
     */
    ProactorSessionConnector(SessionCreator& sessionCreator) :
...
#endif // NSRPC_PROACTORSESSIONCONNECTOR_H
